...
ResourceTexture::ResourceTexture(ResourceTextureType type, unsigned int resourceID) : Resource(nullptr, 0, RESOURCE_TEXTURE, RESOURCE_STORAGE_UNKNOWN, resourceID), textureType(type) { }


ResourceTexture::ResourceTexture(const char* filename, ResourceTextureType type, unsigned int resourceID) : Resource(nullptr, strlen(filename) + 1, RESOURCE_TEXTURE, RESOURCE_STORAGE_FILE, resourceID), textureType(type) {
...
ResourceTexture::ResourceTexture(unsigned int width, unsigned int height, unsigned int pixelSize, const void* const data, ResourceTextureType type, unsigned int resourceID) : Resource(nullptr, 0, RESOURCE_TEXTURE, RESOURCE_STORAGE_BINARY, resourceID), textureType(type) {
